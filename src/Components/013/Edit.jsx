...
function Edit({ modal, setModal, edit, obj }) {
    ...
    const clickEdit = () => {
        const obj = { name, color, id: modal.id, select, red, width, count: parseInt(count) + parseInt(modal.count) }
        edit(obj);
        setModal(null);
    }
        ...
        <div className="modal">
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="form-group">
                        <label>Select</label>
                        <select className="form-control" onChange={e => setSelect(e.target.value)} value={select}>
